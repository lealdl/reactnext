...
function Contato({
  ...
  async function validate() {
    let schema = yup__WEBPACK_IMPORTED_MODULE_4__.object().shape({
      ...
      email: yup__WEBPACK_IMPORTED_MODULE_4__.string("Erro: Necessário preencher o campo email!").required("Erro: Necessário preencher o campo email!"),
