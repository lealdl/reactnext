...
function Contato({ data }) {
    ...
    const sendContact = async e => {
        ...
        try {
            const res = await fetch('http://ch-coder.ddns.net:8090/site-msg-contact/add-msg-contact', {
                method: 'POST',
                            ...
                            <form onSubmit={sendContact}>
                                <div className="fields">
                                    ...
                                    <div className="field email">
                                        <input type="e-mail" name="email" placeholder="Digite o email" onChange={onChangeInput} value={content.email} />
                                    </div>
                                </div>
                                ...
                                <div className="field defeito">
                                    <input type="text" name="defeito" placeholder="Digite o defeito" onChange={onChangeInput} value={content.defeito} />
                                </div>
...
export async function getServerSideProps() {
    const response = await fetch(`http://ch-coder.ddns.net:8090/site-cont-contact/view-content-contact`);
